...
const initialSavedAreas = [
  ...
  { id: "area-3", name: "Dhaka University Campus", category: "campus", thana: "Shahbag", address: "Curzon Hall & TSC Area", safetyScore: 78, recentStatus: "Gathering near Shahbag intersection; detour recommended.", notificationsEnabled: true, position: [23.7326, 90.3943] },
  { id: "area-4", name: "Parents' Residence", category: "family", thana: "Uttara East", address: "Sector 4, Road 11, Uttara", safetyScore: 88, recentStatus: "No active incidents in the last 24 hours.", notificationsEnabled: true, position: [23.8738, 90.3978] },
];
